...
- "Open pangenome ocurrs when the size of the pangenome increases considerably every added genome (p. e. Escherichia coli). Otherwise, in closed pangenomes only few gene families are incorporated to the pangenome when a new member of the clade is added." 
